...
const S_FIRSTPG = 'Previous';										//Defines previous button
const S_NEXT = 'Next';											//Defines next button
const S_LASTPG = 'Next';										//Defines next button
...
const S_RELOAD = 'Return';										//Reloads the image board (refresh)
...
const S_ANOTEXT = '';											//Defines what to print if there is no text entered in the comment field
const S_ANOTITLE = '';											//Defines what to print if there is no text entered into subject field
...
const S_CANNOTWRITE = 'Error: Cannot write to directory.<br>';						//Returns error when the script cannot write to the directory, this is used on initial setup--check your chmod (777)
const S_NOTWRITE = 'Error: Cannot write to directory.<br>';						//Returns error when the script cannot write to the directory, the chmod (777) is wrong
const S_NOTREAD = 'Error: Cannot read from directory.<br>';						//Returns error when the script cannot read from the directory, the chmod (777) is wrong
const S_NOTDIR = 'Error: Directory does not exist.<br>';						//Returns error when the script cannot find/read from the directory (does not exist/isn't directory), the chmod (777) is wrong
